...
//We check if isStudent is equal to true and if zip is greater then 80000 it is not so we move to next conditional.
//we check if isStudent is equal to false or age is less then 30, it is not so we move to next conditional.
//We check is isStudent is equal to true, it is so we log "welcome to Prime!" to the console and exit the conditional statment.
